...
// Every demo accepts an optional `tier` (Demo bar ticket, job 5) so
// components/demos/DemoRoute.tsx can drive its hero from the bar's toggle.
export const demos: Record<string, ComponentType<{ tier?: Tier }>> = {
